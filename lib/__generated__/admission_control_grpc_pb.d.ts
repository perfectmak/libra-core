...
interface IAdmissionControlService_ISubmitTransaction extends grpc.MethodDefinition<admission_control_pb.SubmitTransactionRequest, admission_control_pb.SubmitTransactionResponse> {
...
interface IAdmissionControlService_IUpdateToLatestLedger extends grpc.MethodDefinition<get_with_proof_pb.UpdateToLatestLedgerRequest, get_with_proof_pb.UpdateToLatestLedgerResponse> {
...
export interface IAdmissionControlServer {
    submitTransaction: grpc.handleUnaryCall<admission_control_pb.SubmitTransactionRequest, admission_control_pb.SubmitTransactionResponse>;
...
export interface IAdmissionControlClient {
    submitTransaction(request: admission_control_pb.SubmitTransactionRequest, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
    submitTransaction(request: admission_control_pb.SubmitTransactionRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
    submitTransaction(request: admission_control_pb.SubmitTransactionRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
...
export class AdmissionControlClient extends grpc.Client implements IAdmissionControlClient {
    ...
    public submitTransaction(request: admission_control_pb.SubmitTransactionRequest, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
    public submitTransaction(request: admission_control_pb.SubmitTransactionRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
    public submitTransaction(request: admission_control_pb.SubmitTransactionRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: admission_control_pb.SubmitTransactionResponse) => void): grpc.ClientUnaryCall;
